/**
 * @fileoverview Next.js edge proxy: inject active project ID header for all API routes.
 *
 * The browser stores the active project in a cookie (zeval-project-id).
 * This proxy reads it and forwards it as x-zeval-project-id so every API route
 * sees the correct project context without any component changes.
 */

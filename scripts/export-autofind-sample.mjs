/**
 * 导出 companion-autofind-20sessions.csv（10 正 + 10 负）到 public/sample-data。
 */
...
const outPath = path.join(root, "public", "sample-data", saved.state.fileName ?? "companion-autofind-20sessions.csv");

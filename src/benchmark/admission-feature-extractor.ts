...
export function capabilityToAdmissionChannel(capability: string): string {
  if (capability === "format_compliance") return "ch_format_compliance";
  if (
    ...
    return "ch_decision_accuracy";
  }
  if (capability === "safety_policy") return "ch_uncertainty";
  return "ch_task_completion";
}
/**
